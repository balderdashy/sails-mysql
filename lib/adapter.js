    ...
    query: function(connectionName, collectionName, query, data, cb, connection) {
      ...
      return new Bluebird(function (resolve, reject) {
        ...
        if(_.isUndefined(connection)) {
          spawnConnection(connectionName, __QUERY__, done);
        } else {
          __QUERY__(connection, done);
        }
        ...
        function __QUERY__(connection) {

          // Run query
          if (data) connection.query(query, data, done);
          else connection.query(query, done);
