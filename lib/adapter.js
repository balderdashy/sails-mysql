...
module.exports = (function() {
    ...
    var adapter = {
        ...
        registerCollection: function(collection, cb) {
            ...
            for (var primarykey in def.definition) {
                if (_.has(def.definition[primarykey], 'primaryKey')) {
                    pkName = def.definition[primaryKey].columnName ? def.defitition[primaryKey].columnName : primaryKey;
                }
            }
            ...
            if (dbs[key]) {
                dbs[key.toString()].definition['primaryKeyName'] = pkName;
                return cb();
            } else {
        ...
        update: function(collectionName, options, values, cb) {
            spawnConnection(function(connection, cb) {
                ...
                console.log(collectionName + " : " + dbs[collectionName].definition.primaryKeyName)
