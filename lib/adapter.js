...
module.exports = (function() {
  ...
  function spawnConnection(connectionName, fn, cb) {
    ...
    if (!cb) {
      ...
      var logError = (cb && cb.log && cb.log.error) || console.error;
      cb = function (err) {
        logError(STRINGFILE.noCallbackError,'\n',err);
      };
    }
    ...
    if(!connectionObject) {
      ...
      return cb(new Error('Invalid Connection Name'));
    }

    _spawnConnection(connectionObject, fn, cb);
  }
