...
var STRINGFILE = {
  cantReleaseConnectionWithoutConnection: 'Connection couldn\'t be released because it was never acquired or already released.'
};
...
module.exports = {
  ...
  poolfully: function(conn, cb) {
    if (!conn || typeof conn.release !== 'function') {
      return cb(STRINGFILE.cantReleaseConnectionWithoutConnection);
    }
