...
var sql = module.exports = {
  ...
  _schema: function(collectionName, attribute, attrName) {
    ...
    var setDefault = '';
    if (attribute.defaultsTo && type !== 'LONGTEXT' && type !== 'MEDIUMTEXT'  && type !== 'TEXT'  && type !== 'BLOB') {
      setDefault = ' DEFAULT ' + utils.prepareValue(attribute.defaultsTo);
    }

    return attrName + ' ' + type + ' ' + nullPart + setDefault;
  },
